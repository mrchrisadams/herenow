...
MDNSBrowser.prototype.start = function() {
  ...
  // Service up handler
  // This is currently fairly restricted - it will grab names for some devices and that's about it.
  // Finding the MAC address is the hard part, it's distinctly non-standard across devices,
  // as is the difference in name, host, etc. mDNS doesn't give us the MAC, just the IP.
  // Still, it works after a fashion and helps to name some devices.
