...
// This makes the call to `ifconfig`, using the params we pass in.
...
IfConfig.prototype.probe_localhost = function(interface_name) {
  ...
  // The payoff for all the hard work above. 
  // Emitting these here lets other objects use the mac and ip address
