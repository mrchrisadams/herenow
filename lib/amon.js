...
Amon.prototype.device_url = function(device) {
  return base_url + 'entities/' + entity_uuid + '/devices/' + device.amon_device_uuid;
}
...
Amon.prototype.update_device = function(mac) {
  ...
  db.hgetall(mac, function(err, device_data){
    ...
    url = self.device_url(device_data);
...
Amon.prototype.device_on = function(mac) {
  ...
  db.hgetall(mac, function(err, device_data){
    ...
    url = self.device_url(device_data) + '/measurements';
